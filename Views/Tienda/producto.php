...
<section class="sec-product-detail bg0 p-t-30 p-b-60">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-lg-6 p-b-30">
				<div class="contiene-tabla p-r-10 p-t-5 p-lr-0-lg">
					<h2 class="mtext-116 cl2 js-name-detail p-b-14">
						<?= $arrProducto['nombre']; ?>
					</h2>
					<span class="mtext-112 cl1">
						<?= SMONEY . formatMoney($arrProducto['precio']); ?>
					</span>
					<br>
					<br>
					<span class="mtext-90 cl3">
						Codigo:
						<?= $arrProducto['codigo']; ?>
					</span>
					<br><br>
					<span class="mtext-100 cl3 rounded p-1 border bg-success text-white font-weight-bold">
						Stock:
						<?= $arrProducto['stock']; ?>
					</span>
					<br><br>
					...
					<div class="p-t-33">
						<div class="flex-w flex-l-m p-b-10">
							<div class="size-0 flex-w flex-m respon6-next">
